package com.sandeep.cards.controller;

import com.sandeep.cards.constants.CardsConstants;

import com.sandeep.cards.dto.*;
...
@Tag(
        name = "CRUD REST APIs for Cards in Website",
        description = "CRUD REST APIs in Website to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside Website"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
